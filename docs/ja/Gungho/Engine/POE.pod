...
複数のユーザーエージェント名を使用する事ができます。複数のユーザーエージェント
名を使用するには直接client.agentにユーザーエージェント名を含んだリストを
渡してください。

ただし、他のエンジンはこの機能を実装していない可能性が高いので、設定ファイルを
ポータブルなものにしたい場合は、トップレベルの項目でユーザーエージェント名を
指定してください：
